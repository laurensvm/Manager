//
//  PhotoDetailViewDismissalInterationController.swift
//  Manager
//
...
class PhotoDetailViewDismissalInterationController: NSObject {
    ...
    func didPanWith(gestureRecognizer: UIPanGestureRecognizer) {
        ...
        guard let transitionContext = self.transitionContext,
            let animator = self.animator as? PhotoDetailViewTransition,
            ...
            if velocity.y < 0 || newCenter.y < anchorPoint.y {
                ...
                UIView.animate(
                    ...
                    completion: { completed in
                        ...
                        animator.toDelegate?.transitionDidEndWith(animator: animator)
                        animator.fromDelegate?.transitionDidEndWith(animator: animator)
...
extension PhotoDetailViewDismissalInterationController: UIViewControllerInteractiveTransitioning {
    func startInteractiveTransition(_ transitionContext: UIViewControllerContextTransitioning) {
        self.transitionContext = transitionContext
        
        let containerView = transitionContext.containerView
        
        guard let animator = self.animator as? PhotoDetailViewTransition,
            let fromVC = transitionContext.viewController(forKey: .from),
            let toVC = transitionContext.viewController(forKey: .to),
        ...
        animator.fromDelegate?.transitionWillStartWith(animator: animator)
        animator.toDelegate?.transitionWillStartWith(animator: animator)
